...
export default function Home() {
 ...
 <BackgroundGradientAnimation />
  ...
  <Image
    ...
    src="https://ebzpkkgbkxaixjjjjlkl.supabase.co/storage/v1/object/public/FASHNECT/image.png" width={500} height={500} alt="Coming Soon"/>
 </div>
 <main className="relative z-20  backdrop-blur-sm backdrop-brightness-50 flex flex-col items-center r w-full h-full">
      ...
      <div className="relative z-20  flex-1 gap-4 flex items-center flex-col  px-4 py-8">
        {/* Waitlist Badge */}
        <div>
          <Image src="https://ebzpkkgbkxaixjjjjlkl.supabase.co/storage/v1/object/public/FASHNECT/Fashnect.PNG" className="w-16 h-16 object-cover rounded-xl" width={100} height={100} alt="Fashnect"/>
        </div>
